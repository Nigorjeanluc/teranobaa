...
?>
<div class="container">
	<div style="margin: 200px 0px 200px 0px;" class="row">
		<div class="col-sm-4 col-sm-offset-4 login_bg"   style="background-color:white; padding:10px;border-radius:10px">
